import{d as _,N as u,z as h,f as n,g as t,t as s,B as c,F as f,O as g,o as l,i as v,e as x,C as b}from"../modules/vue-DTPnQ7Sn.js";import{l as N,k,h as m}from"../index-B_QR21M7.js";import{_ as y}from"./NoteDisplay.vue_vue_type_style_index_0_lang-DYpcIN19.js";import"../modules/shiki-BV5ba4Hb.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(D){const{slides:d,total:p}=N();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
